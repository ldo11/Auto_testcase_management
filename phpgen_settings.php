...
{
    $result = array();
    $result[] = array('caption' => 'Teams', 'short_caption' => 'Teams', 'filename' => 'teams.php', 'name' => 'teams', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Questions', 'short_caption' => 'Questions', 'filename' => 'questions.php', 'name' => 'questions', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'RTM', 'short_caption' => 'RTM', 'filename' => 'RTM.php', 'name' => 'RTM', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
function GetMailer()
{
    $smtpOptions = new SMTPOptions('smtp.ionos.com', 587, true, 'hello@luatsqa.com', "abc", 'tls');
    $mailerOptions = new MailerOptions(MailerType::SMTP, 'hello@luatsqa.com', 'Luat SQA', $smtpOptions);
